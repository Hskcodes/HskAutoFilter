...
OWNER_ID = environ.get('OWNER_ID', '831859341')
BOT_TOKEN = environ.get('BOT_TOKEN', "6875897174:AAH9dp4uwpJSK5u_dY2swRVPqdCZydyf2qY")
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002047006186"))
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002111565743') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002068483607') # request channel id ( make sure bot is admin )
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002033299978")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'hskdashing') # owner username without @

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002033299978')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002033299978'))
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002033299978'))
